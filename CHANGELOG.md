...
- Phase 8A local Pi package with canonical skill discovery, grouped installed-CLI tools, bounded argv/stdin process isolation, complete-result/error redaction rules, synthetic process-boundary tests, no-model load smoke, and explicit Pi session-history privacy guidance.
