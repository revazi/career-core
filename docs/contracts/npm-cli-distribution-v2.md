...
This contract describes the Career Core npm source and release boundary. The checked-in `@revazi/career` launcher supports macOS and Linux only. Native Windows is unsupported.
