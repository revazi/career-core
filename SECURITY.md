...
Harness-specific adapter security policies, including the native Pi integration, belong to their separately maintained repositories. Career Core's guarantees cover only the Rust library, CLI/schema, and Swift boundaries shipped here.
